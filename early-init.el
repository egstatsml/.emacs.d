...
(defvar ethan/backup-dir (expand-file-name "backup/" ethan/cache-dir)
  "Where backup files will be stored.")

(defvar ethan/autosave-dir (expand-file-name "autosave/" ethan/cache-dir)
  "Where autosave files will be stored.")

;; make sure the PARENTS arg is true so that if the directory already
;; exists it won't throw an error
(make-directory ethan/backup-dir t)
(make-directory ethan/autosave-dir t)
