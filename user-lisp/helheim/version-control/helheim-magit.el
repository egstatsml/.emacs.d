...
(use-package git-auto-commit-mode
  :ensure t
  :config
  ;; don't want it on by default
  (setq-default git-auto-commit-mode nil)
  (setq-default gac-ask-for-summary-p nil)
  ;; setting default timer to be an hour
  (setq-default gac-debounce-interval 3600)
  ;; auto push after a commit
  (setq-default gac-automatically-push-p t)
  ;; automatically add new files that aren't excluded by
  ;; the .gitignore
  (setq-default gac-automatically-add-new-files-p t)
  ;; make git-auto-commit eval safe in dir-locals
